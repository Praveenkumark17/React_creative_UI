      ...
      >
        <Form autoComplete="off" style={{ marginTop: "20px" }}>
          ...
          >
            ...
            <Flex className="date">
              <div className="date_icon"><MdDateRange size={20} color="#9922c3"/></div>
              <div className="date_pics"><DatePicker className="date_pic" placeholder="please enter Dob"/></div>
            </Flex>
          </Form.Item>
          <Form.Item
            name={"email"}
          ...
          <Form.Item
            name={"check"}
          >
            <Checkbox style={{marginLeft:"10px",fontSize: 15, fontWeight: 600, color: "#9922c3"}}>Remember me</Checkbox>
          </Form.Item>
          <Flex justify="space-between">
            <Form.Item>
              <Button
